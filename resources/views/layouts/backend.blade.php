...
<head>
  ...
  <title>Karim project Admin panel</title>
      ...
      <div class="js-sidebar-scroll">
        ...
        <div class="content-side">
          <ul class="nav-main">
            ...
            <li class="nav-main-heading">zerkala-tatarstan.ru</li>
            <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
              <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                <i class="nav-main-link-icon si si-bulb"></i>
                <span class="nav-main-link-name">Управление контентом</span>
              </a>
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                    <a class="nav-main-link{{ request()->is('pages/portfolio') ? ' active' : '' }}" href="/pages/portfolio">
                      <span class="nav-main-link-name">Портфолио</span>
                    </a>
                  </li>
                <li class="nav-main-item">
                  <a class="nav-main-link{{ request()->is('pages/catalog') ? ' active' : '' }}" href="/pages/catalog">
                    <span class="nav-main-link-name">Каталог материалов</span>
                  </a>
                </li>

                <li class="nav-main-item">
                    <a class="nav-main-link{{ request()->is('pages/banners') ? ' active' : '' }}" href="/pages/banners">
                      <span class="nav-main-link-name">Баннеры</span>
                    </a>
                  </li>
